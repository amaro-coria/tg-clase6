...
public class CatalogoGeneral implements Serializable, Cloneable {
	...
	@Override
	protected CatalogoGeneral clone() throws CloneNotSupportedException {
		return (CatalogoGeneral) super.clone();
	}
